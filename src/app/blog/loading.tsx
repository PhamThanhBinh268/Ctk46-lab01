  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        {[1, 2, 3].map((i) => (
          <div key={i} className="border dark:border-gray-800 rounded-lg p-6 bg-white dark:bg-gray-900">
            ...
            <div className="h-4 w-2/3 bg-gray-200 dark:bg-gray-800 rounded animate-pulse mt-1" />
          </div>
        ))}
      </div>
    </div>
