  ...
  return (
    <div className="flex items-center gap-4">
      <button
        ...
        className="bg-gray-200 hover:bg-gray-300 w-10 h-10 rounded-lg text-xl font-bold transition-colors dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white"
      >
        -
      </button>
